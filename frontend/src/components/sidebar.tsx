...
const TIER_LABELS: Record<string, string> = {
  ...
  "strand-1-number-quantity-master": "Number Sense — Master",
  "strand-1-number-quantity-research": "Number Sense — Research-adjacent",
  "strand-2-structure-foundation": "Structure — Foundation",
  "strand-2-structure-intermediate": "Structure — Intermediate",
  "strand-2-structure-advanced": "Structure — Advanced",
  "strand-2-structure-master": "Structure — Master",
  "strand-2-structure-research": "Structure — Research-adjacent",
  "strand-3-shape-space-foundation": "Shape & Space — Foundation",
  "strand-3-shape-space-intermediate": "Shape & Space — Intermediate",
  "strand-3-shape-space-advanced": "Shape & Space — Advanced",
  "strand-3-shape-space-master": "Shape & Space — Master",
  "strand-3-shape-space-research": "Shape & Space — Research-adjacent",
  "strand-4-change-foundation": "Change — Foundation",
  "strand-4-change-intermediate": "Change — Intermediate",
  "strand-4-change-advanced": "Change — Advanced",
  "strand-4-change-master": "Change — Master",
  "strand-4-change-research": "Change — Research-adjacent",
  ...
  "strand-5-pattern-counting-advanced": "Pattern & Counting — Advanced",
  "strand-5-pattern-counting-master": "Pattern & Counting — Master",
  "strand-5-pattern-counting-research": "Pattern & Counting — Research-adjacent",
  "strand-6-uncertainty-foundation": "Uncertainty — Foundation",
  "strand-6-uncertainty-intermediate": "Uncertainty — Intermediate",
  "strand-6-uncertainty-advanced": "Uncertainty — Advanced",
  "strand-6-uncertainty-master": "Uncertainty — Master",
  "strand-6-uncertainty-research": "Uncertainty — Research-adjacent",
  "strand-7-computation-foundation": "Computation — Foundation",
  "strand-7-computation-intermediate": "Computation — Intermediate",
  "strand-7-computation-advanced": "Computation — Advanced",
  "strand-7-computation-master": "Computation — Master",
  "strand-7-computation-research": "Computation — Research-adjacent",
  "strand-8-reasoning-foundation": "Reasoning — Foundation",
  "strand-8-reasoning-intermediate": "Reasoning — Intermediate",
  "strand-8-reasoning-advanced": "Reasoning — Advanced",
  "strand-8-reasoning-master": "Reasoning — Master",
  "strand-8-reasoning-research": "Reasoning — Research-adjacent",
};
